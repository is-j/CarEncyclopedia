...
public class MercedesEngine extends Application {
    ...
    @Override
    public void start(Stage mercedesEngineStage) throws Exception {
        ...
        Image mercedesEngineImage = new Image("ferrariEngine2.png");
        ImageView imageView = new ImageView(mercedesEngineImage);
        ...
        File mediaFile = new File("mercedesEngineVideo.mp4");
        ...
        Label label = new Label("Mercedes Engine Overview");
     ...
     // Create Text objects to hold the engine overview text
        ...
        Label designDetailsText = new Label("The Mercedes engine is a masterwork of precision engineering, combining cutting-edge technologies with time-tested craftsmanship. \nEvery aspect of the engine design is carefully considered to achieve maximum performance, efficiency, and durability.");
        ...
        Label materialsDetailsText = new Label("Mercedes engines are built using only the finest materials, including high-strength alloys and advanced composites. These materials are chosen \nfor their superior properties, such as strength, durability, and heat resistance, to ensure optimal engine performance under extreme conditions.");
        ...
        Label assemblyDetailsText = new Label("The engine components are then carefully assembled by skilled technicians, who fit each part together with extreme precision. Every component \nis double-checked for accuracy and quality to ensure that the engine operates smoothly and reliably.");
        ...
        Label testingDetailsText = new Label("Mercedes engines undergo rigorous testing to ensure that they meet the highest standards of performance and reliability. \nBench testing and on-track testing are used to evaluate engine performance and durability under a variety of conditions. \nThe engines are then tuned to optimize performance and ensure maximum power and torque.");
        ...
        Text bottomText1 = new Text("Mercedes Owners Club");
        ...
        Text bottomText2 = new Text("Become a part of the exclusive world of Mercedes");
        ...
        bottomButton.setStyle("-fx-background-color: #C8CCCE; -fx-text-fill: white; -fx-font-size: 18; -fx-font-weight: bold;");
        ...
        mercedesEngineStage.setScene(scene);
        mercedesEngineStage.setTitle("The Mercedes Engine");
        mercedesEngineStage.show();
        ...
        backButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
            	mercedesEngineStage.close();
                Mercedes merc = new Mercedes();
                try {
                	merc.start(mercedesEngineStage);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
