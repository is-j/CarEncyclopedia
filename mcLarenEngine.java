...
public class mcLarenEngine extends Application {
    ...
    @Override
    public void start(Stage mcLarenEngineStage) throws Exception {
        ...
        Image mcLarenEngineImage = new Image("ferrariEngine2.png");
        ImageView imageView = new ImageView(mcLarenEngineImage);
        ...
        File mediaFile = new File("mcLarenEngineVideo.mp4");
        ...
        Label label = new Label("McLaren Engine Overview");
     ...
     // Create Text objects to hold the engine overview text
        ...
        Label designDetailsText = new Label("The McLaren engine is designed with performance and efficiency in mind. The design features advanced technologies such as direct fuel injection, variable valve timing, and a lightweight crankshaft, which help to improve fuel efficiency and reduce emissions. The engine is also designed to be compact and lightweight, which helps to improve handling and overall performance.");
        designDetailsText.setFont(Font.font("Ferrari SF", FontWeight.BOLD, 16));
        designDetailsText.setWrapText(true);
        ...
        Label materialsDetailsText = new Label("The materials used in the construction of the McLaren engine are carefully selected to provide the perfect balance of strength, durability, and performance. The engine features lightweight alloys like titanium and aluminum, as well as high-strength materials like carbon fiber and reinforced polymers. These materials are chosen to provide the perfect combination of strength and weight, helping to improve overall performance.");
        materialsDetailsText.setFont(Font.font("Ferrari SF", FontWeight.BOLD, 16));
        materialsDetailsText.setWrapText(true);
        ...
        Label castingDetailsText = new Label("The McLaren engine components are precision-cast using advanced techniques and state-of-the-art equipment. The casting process is carried out to the strictest tolerances, ensuring that each component is precisely crafted to meet the highest standards of quality and performance. The components are then machined to exact specifications, ensuring that each piece fits perfectly with the others.");
        castingDetailsText.setFont(Font.font("Ferrari SF", FontWeight.BOLD, 16));
        castingDetailsText.setWrapText(true);
        ...
        Label assemblyDetailsText = new Label("The assembly of the McLaren engine is carried out by highly skilled technicians, who carefully fit each component together to ensure that the engine operates smoothly and efficiently. The assembly process is carried out with extreme precision, with each component checked and double-checked for accuracy and quality. The end result is an engine that operates at the highest levels of performance and reliability.");
        assemblyDetailsText.setFont(Font.font("Ferrari SF", FontWeight.BOLD, 16));
        assemblyDetailsText.setWrapText(true);
        ...
        Label testingDetailsText = new Label("Once the McLaren engine is assembled, it undergoes rigorous testing to ensure that it meets the highest standards of performance and reliability. This includes both bench testing and on-track testing, where the engine is put through its paces in simulated racing conditions. The engine is also tuned to optimize its performance and ensure that it delivers maximum power and torque.");
        testingDetailsText.setFont(Font.font("Ferrari SF", FontWeight.BOLD, 16));
        testingDetailsText.setWrapText(true);
        ...
        Text bottomText1 = new Text("McLaren Owners Club");
        ...
        Text bottomText2 = new Text("Become a part of the exclusive world of McLaren");
        ...
        bottomButton.setStyle("-fx-background-color: #FF8000; -fx-text-fill: white; -fx-font-size: 18; -fx-font-weight: bold;");
        ...
        mcLarenEngineStage.setScene(scene);
        mcLarenEngineStage.setTitle("The McLaren Engine");
        mcLarenEngineStage.show();
        ...
        backButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
            	mcLarenEngineStage.close();
                Mercedes merc = new Mercedes();
                try {
                	merc.start(mcLarenEngineStage);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
